...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background p-0 text-foreground lg:p-4">
      <main className="relative grid h-dvh w-full max-w-5xl overflow-hidden rounded-none border-0 bg-card shadow-sm lg:h-[calc(100dvh-32px)] lg:max-h-[760px] lg:rounded-[28px] lg:border lg:border-border lg:grid-cols-2">
        ...
        <div className="brand-panel hidden lg:flex lg:flex-col lg:justify-between lg:p-12">
          ...
          <div className="animate-login-hero-enter">
            <p className="font-display text-5xl font-semibold leading-tight tracking-tight">Talent Lab</p>
        ...
        <div className="grid place-items-center px-4 py-12">
          <form onSubmit={handleSubmit} className="w-full max-w-sm animate-login-form-enter">
            <BrandMark
              className="mb-6 h-12 w-12 rounded-xl shadow-sm"
              iconClassName="h-5 w-5"
            />
            <h1 className="font-display text-2xl font-semibold tracking-tight">Talent Lab</h1>

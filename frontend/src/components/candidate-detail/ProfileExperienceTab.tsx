          ...
          {workExperience.map((item, index) => {
            ...
            return (
              <div key={index} className="relative group">
                <div className="absolute -left-[32px] top-1.5 h-4 w-4 rounded-full border-2 border-background bg-success shadow-sm transition-transform group-hover:scale-110" />
